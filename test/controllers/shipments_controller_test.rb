...
class ShipmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipment" do
    assert_difference("Shipment.count") do
      post shipments_url, params: { shipment: { item_id: @shipment.item_id, partner_id: @shipment.partner_id, status: @shipment.status, user_id: @shipment.user_id } }
    end
  ...
  test "should update shipment" do
    patch shipment_url(@shipment), params: { shipment: { item_id: @shipment.item_id, partner_id: @shipment.partner_id, status: @shipment.status, user_id: @shipment.user_id } }
